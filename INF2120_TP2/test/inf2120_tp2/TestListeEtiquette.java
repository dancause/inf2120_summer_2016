...
public class TestListeEtiquette {
	...
	private static final Etiquette E1 = new Etiquette( ID1, 1, 2 );
        private static final Etiquette E5 = new Etiquette( ID1, 1, 3 );
	 ...
	 */
	private <E> void assertContenuEgalSansOrdre( String mssg,Iterator< E > attendu,Iterator< E > recu ) {
		Iterable< E > iterableAttendu = () -> attendu;
		Iterable< E > iterableRecu = () -> recu;
		
assertContenuEgal( mssg,StreamSupport.stream( iterableAttendu.spliterator(), false ).sorted().iterator(),
	 ...
	 * @param recu     : un Iterator sur les resultat produits.
	 */
	private <E> void assertContenuEgal( String mssg,Iterator< E > attendu, Iterator< E > recu ) {
